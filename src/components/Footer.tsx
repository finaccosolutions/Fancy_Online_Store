        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href={settings.footerSocialFacebook || '#'} className="text-[#D4AF37] hover:text-white transition-colors">
                <Facebook className="h-5 w-5" />
              </a>
              <a href={settings.footerSocialInstagram || '#'} className="text-[#D4AF37] hover:text-white transition-colors">
                <Instagram className="h-5 w-5" />
              </a>
              <a href={settings.footerSocialTwitter || '#'} className="text-[#D4AF37] hover:text-white transition-colors">
          ...
          <div className="sm:col-span-2 md:col-span-2 grid grid-cols-2 gap-4 sm:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-1.5 sm:space-y-2 text-sm sm:text-base">
                ...
                <li>
                  <Link to="/returns" className="text-gray-300 hover:text-[#D4AF37] transition-colors">
                    Returns & Exchanges
                  </Link>
                </li>
                <li>
          ...
          <div className="sm:col-span-2 md:col-span-1">
            <h4 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-[#D4AF37]">Contact Info</h4>
            <div className="space-y-2 sm:space-y-3 text-sm sm:text-base">
              <div className="flex items-start space-x-2 sm:space-x-3">
                <MapPin className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[#D4AF37] mt-1 flex-shrink-0" />
                <span className="text-gray-300 text-xs sm:text-sm">
                  {settings.contactAddressLine1 || 'India'}
                </span>
              </div>
              <div className="flex items-center space-x-2 sm:space-x-3">
                <Phone className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[#D4AF37] flex-shrink-0" />
                <span className="text-gray-300 text-xs sm:text-sm">{settings.contactPhone1 || '+91 XXXXXXXXXX'}</span>
              </div>
              <div className="flex items-center space-x-2 sm:space-x-3">
                <Mail className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[#D4AF37] flex-shrink-0" />
        ...
        <div className="border-t border-gray-700 mt-6 sm:mt-8 pt-6 sm:pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
              <Link to="/privacy" className="text-gray-400 hover:text-[#D4AF37] transition-colors text-sm">
                Privacy Policy
              </Link>
              <Link to="/terms" className="text-gray-400 hover:text-[#D4AF37] transition-colors text-sm">
                Terms of Service
              </Link>
            </div>
          </div>
